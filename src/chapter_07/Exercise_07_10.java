package chapter_07;
/*Write a method that returns the index of the smallest element in an array of doubles.  
 * If the number of such elements is greater than 1, return the smallest index. 
 * Use the following header:publicstaticintindexOfSmallestElement(double[] array)
...
public class Exercise_07_10 {
	...
	public static void main(String[] args) {
		...
		double[] numbers = new double[10]; // Create an array that holds ten numbers
